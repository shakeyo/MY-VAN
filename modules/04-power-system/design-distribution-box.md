...
> **扩展策略**：未来增加的"分散独立按钮"，DI 接 中4 X3-X4、额头空闲 DI；LED 接 16DO.Y13-16（余4）；负载接 中8.Y8 + 中4.Y1-4（余5）。再不够就在 485 总线上再挂一个模块 —— 永远不动现有接线。详细通道分配见 [switch-assignment.md](switch-assignment.md)。
...
- **主控面板 键5-6**（冰箱/灯光模式）→ 8P 短跳线（一根）→ 中4 DI1-2，LED 走 16DO.Y9/Y10
...
### LED 指示线（束3 · 独立 LED 阴 · 全走 16DO）

| 标签 | 含义 |
|------|------|
| `16DO-LED阴-入口键1` | 入口键1 LED 阴 → 16DO.Y1.COM |
| `16DO-LED阴-入口键2` | 入口键2 LED 阴 → 16DO.Y2.COM |
| `16DO-LED阴-入口键3` | 入口键3 LED 阴 → 16DO.Y3.COM |
| `16DO-LED阴-入口键4` | 入口键4 LED 阴 → 16DO.Y4.COM |
| `16DO-LED阴-主控键1` | 主控键1 LED 阴 → 16DO.Y5.COM |
| `16DO-LED阴-主控键2` | 主控键2 LED 阴 → 16DO.Y6.COM |
| `16DO-LED阴-主控键3` | 主控键3 LED 阴 → 16DO.Y7.COM |
| `16DO-LED阴-主控键4` | 主控键4 LED 阴 → 16DO.Y8.COM |
| `16DO-LED阴-主控键5` | 主控键5 LED 阴 → 16DO.Y9.COM |
| `16DO-LED阴-主控键6` | 主控键6 LED 阴 → 16DO.Y10.COM |
| `16DO-LED阴-车尾1` | 车尾扩展1 LED 阴 → 16DO.Y11.COM |
| `16DO-LED阴-车尾2` | 车尾扩展2 LED 阴 → 16DO.Y12.COM |

> LED 阳极（共阳）统一标 `LED+共阳`（红），进 +12V 控+。

### DI 按钮输入线（束3）

| 标签 | 含义 |
|------|------|
| `中8-DI-入口键1` | 14A芯3白 → X1（排水） |
| `中8-DI-入口键2` | 14A芯4黄 → X2（户外灯） |
| `中8-DI-入口键3` | 14A芯5灰 → X3（泵） |
| `中8-DI-入口键4` | 14A芯6淡绿 → X4（离车驻车） |
| `中8-DI-主控键1` | 14B芯3白 → X5（主灯） |
| `中8-DI-主控键2` | 14B芯4黄 → X6（氛围） |
| `中8-DI-主控键3` | 14B芯5灰 → X7（排气扇） |
| `中8-DI-主控键4` | 14B芯6淡绿 → X8（泵） |
| `中4-DI-主控键5` | 8P位3白 → X1（冰箱） |
| `中4-DI-主控键6` | 8P位4黄 → X2（灯光模式） |
...
5. **标签与 SVG 图编号一一对应**：图中的 Y1/Y2…、X1/X8…、14A/14B 芯号，就是标签里的编号来源。
